...
*/
void compute_stats() {
    stats.aat = (double)((double)(DISK_PAGE_WRITE_TIME * stats.writebacks) + (double)(DISK_PAGE_READ_TIME * stats.page_faults) +
    (double)(MEMORY_READ_TIME * stats.accesses))/(stats.accesses + 0.0);
}
